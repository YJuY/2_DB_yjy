...
SELECT ROUND(123.456, -2) FROM DUAL; -- 10의 자리에서 반올림해서 100의자리 부터 표현
...
SELECT LAST_DAY('2022-02-01')FROM UAL; -- 
...
SELECT SYSDATE FROM DUAL; --2022-09-01 11:20:47.000
...
--> 패턴을 저굥해서 작성된 문자열의 각 문자가 어떤 날짜 형식인지 인지시킴


-- EMPLOYEE 티이블에서 각 지원이 태어난 생년월일(1990년 05월13일) 조회
SELECT EMP_NAME, 
...
SELECT TO_DATE('510505', 'YYMMDD') FROM DUAL; -- 2049-05-05 00:00:00.000
...
/* NULL과 산술 연산을 진행하면 결고는 문조건 NULL */
...
SELECT EMP_NAME, SALARY,
	CASE
		...
		WHEN SALARY >= 3000000 THEN '중' -- esle IF
		ELSE '소'
	END "급여 받는 정도"
FROM EMPLOYEE;
...
--  COUNT(컬럼명)에 의해 NULL을 제외한 살제 값이 있는 행의 개수만 조회
