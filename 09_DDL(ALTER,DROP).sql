...
-- DEPT_COPY의 DEPT_TITLE 컬럼에 UNIOUE 삭제
ALTER TABLE DEPT_COPY
...
-- 컬럼 추가
-- ALTER TABLE 테이블명 ADD(컬럼명 데이터타입 [DERAULT '값']);
...
SELECT * FROM DEPT_COPY;
--> 컬럼이 생성되면서 DERAULT 값이 자동 삽입됨.



-- D10 개발1팀 추가
INSERT INTO DEPT_COPY
VALUES('D10', '개발팀', 'L1', DEFAULT, DEFAULT);
-- "KH_YJY"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
SELECT *FROM DEPT_COPY; -- UPDATE 학인
COMMIT;
...
-- 3) DROP TABLE 삭제옵션 CASCAED CONSTRAINTS 사용
...
/* DDL 주의 사항 */
-- 1) DDL은 DOMMIT/ROLLBACK이 되지 않는다.
